...
我是开发iOS的，前端时间看了一下weex,利用weex开发，可以实时、方便的看到自己做出来的页面在手机上运行出来的效果，加载数据极为流畅。我是前端的小白，但是我会一直不断努力、不断学习，与weex共成长。利用业余时间用weex仿写了大神lanxiner123的这款关于皇室战争游戏的小型App。
...
## 关于此项目运用
如果想运行此项目，直接克隆下来，把DemoDefine.h文件里的CURRENT_IP改成自己电脑的ip，运行即可。
